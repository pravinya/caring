...
class Ad extends CActiveRecord
{
	...
	public function relations()
	{
		return array(
			...
			'Categories' => array(self::MANY_MANY, 'Category', 'ad_category(category_id, ad_id)'),
		);
	}
        public function behaviors(){
            ...
            return array(
		     ...
		     // 'params'=>array('id'=>$this->id, 'title'=>$this->cname),
                      'params'=>array( 'adtitle'=> stripslashes($this->ad_title),'adid'=>$this->ad_id),
                    ),
           );
           }
	public function getLink()
	{
	        ...
	        return $this->getAbsoluteUrl(array('adtitle' => DCUtil::getSeoTitle( stripslashes($this->ad_title) ), 'adid' => $this->ad_id));
	}
