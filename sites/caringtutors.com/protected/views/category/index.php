...
<?php echo "<div id='".Category::ADMIN_TREE_CONTAINER_ID."'></div>";?> 
...
$("#<?php echo Category::ADMIN_TREE_CONTAINER_ID;?>")
		.jstree({
	            ...
	            "ajax" : {
                                 "type":"POST",
 	                          "url" : "<?php echo $baseUrl;?>/userGroups/category/fetchTree",
	                         "data" : function (n) {
	                          return {
...
"update" : {
	              ...
	              "action"	: function (obj) {
                     ...
                     $.ajax({
                                 type: "POST",
                                 url: "<?php echo $baseUrl;?>/userGroups/category/returnForm",
                                data:{
                                          'update_id':  id,
                                           "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
	...
	"action" : function (obj) {
                             ...
                             $.ajax({
                                   type:"POST",
			           url:"<?php echo $baseUrl;?>/userGroups/category/returnView",
		                   data:   {
                                             "id" :id,
                                            "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
...
//	}//list products
		...
		$.ajax({
                           type:"POST",
			   url:"<?php echo $baseUrl;?>/userGroups/category/rename",
			   data:  {
		...
		$.ajax({
                           type:"POST",
			    url:"<?php echo $baseUrl;?>/userGroups/category/remove",
			    data:{
				        "id" : data.rslt.obj.attr("id").replace("node_",""),
			                "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                        },
...
//                      console.log(replaced_node,'REPLACED NODE');
			...
			$.ajax({
				async : false,
				type: 'POST',
				url: "<?php echo $baseUrl;?>/userGroups/category/moveCopy",
