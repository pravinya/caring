...
class CategoryController extends Controller
{
    ...
    {
        return array(
            'jsTreeBehavior' => array('class' => 'userGroups.behaviors.JsTreeBehavior',
                'modelClassName' => 'Category',
                'form_alias_path' => 'userGroups.views.category._form',
                'view_alias_path' => 'userGroups.views.category.view',
                'label_property' => 'name',
                'rel_property' => 'name'
            )
        );
