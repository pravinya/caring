...
?>
<h1><?php echo UserGroupsModule::t('Manage Profile Fields'); ?></h1>

<p><?php echo UserGroupsModule::t("You may optionally enter a comparison operator (<b>&lt;</b>, <b>&lt;=</b>, <b>&gt;</b>, <b>&gt;=</b>, <b>&lt;&gt;</b> or <b>=</b>) at the beginning of each of your search values to specify how the comparison should be done."); ?></p>

<?php echo CHtml::link(UserGroupsModule::t('Advanced Search'),'#',array('class'=>'search-button')); ?>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'title',
			'value'=>'UserGroupsModule::t($data->title)',
		),
		array(
			'name'=>'field_type',
