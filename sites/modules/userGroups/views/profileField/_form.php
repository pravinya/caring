...
<?php echo CHtml::beginForm(); ?>
	...
	<p class="note"><?php echo UserGroupsModule::t('Fields with <span class="required">*</span> are required.'); ?></p>
	...
	<div class="row varname">
		...
		<p class="hint"><?php echo UserGroupsModule::t("Allowed lowercase letters and digits."); ?></p>
	</div>
	...
	<div class="row title">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Field name on the language of "sourceLanguage".'); ?></p>
	</div>
	...
	<div class="row field_type">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Field type column in the database.'); ?></p>
	</div>
	...
	<div class="row field_size">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Field size column in the database.'); ?></p>
	</div>
	...
	<div class="row field_size_min">
		...
		<p class="hint"><?php echo UserGroupsModule::t('The minimum value of the field (form validator).'); ?></p>
	</div>
	...
	<div class="row required">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Required field (form validator).'); ?></p>
	</div>
	...
	<div class="row match">
		...
		<p class="hint"><?php echo UserGroupsModule::t("Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')."); ?></p>
	</div>
	...
	<div class="row range">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).'); ?></p>
	</div>
	...
	<div class="row error_message">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Error message when you validate the form.'); ?></p>
	</div>
	...
	<div class="row other_validator">
		...
		<p class="hint"><?php echo UserGroupsModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('file'=>array('types'=>'jpg, gif, png'))))); ?></p>
	</div>
	...
	<div class="row default">
		...
		<p class="hint"><?php echo UserGroupsModule::t('The value of the default field (database).'); ?></p>
	</div>
	...
	<div class="row widget">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Widget name.'); ?></p>
	</div>
	...
	<div class="row widgetparams">
		...
		<p class="hint"><?php echo UserGroupsModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('param1'=>array('val1','val2'),'param2'=>array('k1'=>'v1','k2'=>'v2'))))); ?></p>
	</div>
	...
	<div class="row position">
		...
		<p class="hint"><?php echo UserGroupsModule::t('Display order of fields.'); ?></p>
	</div>
	...
	<div class="row buttons">
		<?php echo CHtml::submitButton($model->isNewRecord ? UserGroupsModule::t('Create') : UserGroupsModule::t('Save')); ?>
	</div>

<?php echo CHtml::endForm(); ?>

</div><!-- form -->
<div id="dialog-form" title="<?php echo UserGroupsModule::t('Widget parametrs'); ?>">
	<form>
	<fieldset>
