...
if ($mode === 'profile') {
	...
	$userGroupsMenu[] = array('label'=>Yii::t('userGroupsModule.general','Edit Profile'), 'url'=>array('user/update', 'id'=>Yii::app()->user->id), 'linkOptions'=> array('onclick' => 'js: return loadPage(this)'), 'visible' => Yii::app()->user->pbac(array('user.admin', 'admin.admin')));
else if ($mode === 'admin') {
	$userGroupsMenu[] = array('label'=>Yii::t('userGroupsModule.general','My Profile'), 'url'=>array('/userGroups'), 'linkOptions'=> array('onclick' => 'js: return loadPage(this)'), 'visible' => !Yii::app()->user->isGuest);
...
$userGroupsMenu[] = array('label'=>Yii::t('userGroupsModule.general','Category Admin'), 'url'=>array('category/tree'), 'linkOptions'=> array('onclick' => ''), 'visible' => Yii::app()->user->pbac(array('user.admin', 'admin.admin')), 'active' => isset($invite));
