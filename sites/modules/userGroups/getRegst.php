	  ...
	  $session = Yii::app()->session;
	   ...
	   // $regist_form_model->scenario = 'verification';
	           ...
	           if( $regst_form_model->save()){   
	                  Yii::app()->user->setFlash('signup','Registration Successful.Please visit your registered email <b>'.$regst_form_model->email.'</b> for instructions to complete your registration. Thank you.');
