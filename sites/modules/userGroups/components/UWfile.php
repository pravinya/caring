...
class UWfile {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>UserGroupsModule::t('File field'),
			'fieldType'=>array('VARCHAR'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'path'=>UserGroupsModule::t('Upload path'),
			),
	...
	public function editAttribute($model,$field,$params=array()) {
		...
		.' '.CHtml::activeLabelEx($model,'[uwfdel]'.$field->varname,array('label'=>UserGroupsModule::t('Delete file'),'style'=>'display:inline;')):'')
		;
	}
