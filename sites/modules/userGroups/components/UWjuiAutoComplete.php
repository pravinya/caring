...
class UWjuiAutoComplete {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>UserGroupsModule::t('jQueryUI autocomplete',array(),__CLASS__),
			'fieldType'=>array('INTEGER'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'modelName'=>UserGroupsModule::t('Model Name',array(),__CLASS__),
				'optionName'=>UserGroupsModule::t('Lable field name',array(),__CLASS__),
				'emptyFieldLabel'=>UserGroupsModule::t('Empty item name',array(),__CLASS__),
				'emptyFieldValue'=>UserGroupsModule::t('Empty item value',array(),__CLASS__),
				'relationName'=>UserGroupsModule::t('Profile model relation name',array(),__CLASS__),
				'minLength'=>UserGroupsModule::t('minimal start research length',array(),__CLASS__),
			),
		);
	}
