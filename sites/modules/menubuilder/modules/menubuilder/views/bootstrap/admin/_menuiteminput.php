    ...
    <?php endif; ?>
        ...
        if (!$isNew && $this->menuitemActionAllowed('update'))
            ...
            $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'submit', 'label'=>Yii::t('MenubuilderModule.messages', 'Save'),
                          'htmlOptions'=>array('name'=> EMBConst::BUTTONNAME_UPDATEITEM, 'onclick' => 'nestedConfigToHidden();')));
        ...
        if ($this->menuitemActionAllowed('create'))
            $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'submit', 'label'=>Yii::t('MenubuilderModule.messages', 'Append new'),
                'htmlOptions'=>array('name'=> EMBConst::BUTTONNAME_CREATEITEM, 'onclick' => 'nestedConfigToHidden();')));
        ...
        if (!$isNew && $this->menuitemActionAllowed('delete'))
            $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'submit', 'label'=>Yii::t('MenubuilderModule.messages', 'Delete'),
                'htmlOptions'=>array('name'=> EMBConst::BUTTONNAME_DELETEITEM, 'onclick' => 'nestedConfigToHidden();','class'=>'pull-right')));
        ?>
    </div>
