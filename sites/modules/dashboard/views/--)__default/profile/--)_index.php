...
<?php if($model2->cv_id > 0):    ?>
  ...
  <h4> <?php echo $model2->title.' - '.$model2->location;echo 'Hiiiiiiii';?></h4>

    <div class="pull-right"><?php
echo CHtml::link( '<i class="icon-edit"></i>Update Profile', array( 'tutor/update','id'=>Yii::app()->user->id ),
  array(
    ...
    <div class="span4">Hello
        <?php   $lgid = !empty($model2->imageId) ? $model2->imageId : 1;
		  ...
		  $this->widget('ext.imageSelect.ImageSelect',  array(
                                 ...
                                 'alt'=>'alt text',
                                 'uploadUrl'=>$this->createUrl('content/uploadAvatar',array('imid'=>$model2->imageId)),
                                 'htmlOptions'=>array()
               ));  ?>
